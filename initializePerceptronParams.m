...
r  = sqrt(6) / sqrt(outputSize+inputSize+1);   % we'll choose weights uniformly from the interval [-r, r]
W1 = rand(outputSize, inputSize) * 2 * r - r; % hidden layer * input layer sized
